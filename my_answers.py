...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        #print("self.weights_input_to_hidden: {}".format(np.shape(self.weights_input_to_hidden)))
        self.weights_hidden_to_output = np.random.normal(0.0, self.hidden_nodes**-0.5, 
                                       (self.hidden_nodes, self.output_nodes))
        #print("self.weights_hidden_to_output: {}".format(np.shape(self.weights_hidden_to_output)))
    ...
    def train(self, features, targets):
        ...
        #print("delta_weights_i_h: {}".format(np.shape(delta_weights_i_h)))
        delta_weights_h_o = np.zeros(self.weights_hidden_to_output.shape)
        #print("delta_weights_h_o: {}".format(np.shape(delta_weights_h_o)))
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        #print("output_error_term: {}".format(np.shape(output_error_term)))       
